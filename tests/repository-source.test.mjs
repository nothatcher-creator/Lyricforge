...
test('normal clone contains complete runnable source and script entrypoints',async()=>{
  for(const p of ['styles.css','ui-polish.css','src/app.mjs','tools/dev-server.mjs','tools/run-node-tests.mjs','CHANGELOG.md','IMPLEMENTATION_STATUS.md','tests/shell.test.mjs','tests/browser-layout.test.mjs','tests/workflow.test.mjs'])await exists(p);
